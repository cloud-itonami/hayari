...
```
$ kbb --backend sci --classpath src:test test/hayari/core_test.cljk
...
```
$ kbb --backend sci --classpath src:test:../../kotoba-lang/org-oasis-open-xmile/src \
...
```
$ kbb --backend sci src/hayari/collect.cljk --date 2026-08-08 --days 4 --top 15 \
...
```
$ kbb --backend sci src/hayari/collect.cljk
```
...
```
$ kbb --backend sci src/hayari/collect.cljk --date 2026-08-07 --top 5 --budget-ms 3000
...
```
$ kbb --backend sci src/hayari/collect.cljk --date 2026-08-08 --top 200 --countries JP,GB
...
```
$ kbb --backend sci src/hayari/corpus.cljk --data /tmp/era-test.edn \
...
```
$ kbb --backend sci src/hayari/simulate.cljk --data /tmp/multi2.edn --out /tmp/xmile-fit2.edn
...
```
$ kbb --backend sci src/hayari/simulate.cljk --by domain --data /tmp/dom.edn
...
```
$ kbb --backend sci --classpath ".:scripts/nbb_compat" scripts/observatory-run.cljs --only hayari
